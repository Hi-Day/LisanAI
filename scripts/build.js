...
async function main() {
  const result = await build({
    ...
    logLevel: "info",
    banner: {
      js: `import("/js/learning-outcome-trend.js").catch(() => {});import("/js/probing-gate.js").then(m=>m.installProbingGate()).catch(()=>{});import("/js/pedagogical-gate.js").catch(()=>{});import("/js/assessment-outcomes-ux.js").catch(()=>{});import("/js/assessment-outcomes-ai.js").catch(()=>{});${assessmentUxEnhancement}${uiPolishEnhancement}`,
    },
  });
