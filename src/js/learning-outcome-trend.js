...
async function refresh() {
  ...
  if (!container) return;
  try {
    renderTrajectory(container, legend, await loadTrajectory());
  } catch {
    container.innerHTML = '<p class="empty-state">Trajectory belum dapat dimuat. Data assessment tetap tersimpan.</p>';
  }
}
